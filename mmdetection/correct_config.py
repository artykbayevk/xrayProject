_base_ = '/mmdetection/configs/detectors/cascade_rcnn_r50_rfp_1x_coco.py'
...
train_pipeline = [
    ...
    dict(
        ...
        bbox_params=dict(type="BboxParams", format="pascal_voc", label_fields=['gt_labels'], filter_lost_elements=True,
...
data = dict(
    ...
    train=dict(
        img_prefix='/data/augmented/',
        classes=classes,
        ann_file='/data/augmented/train.json',
        pipeline=train_pipeline,
        filter_empty_gt=False),
    val=dict(
        img_prefix='/data/augmented',
        classes=classes,
        ann_file='/data/augmented/test.json',
...
work_dir = "/data/work_dir/correct_augmented"