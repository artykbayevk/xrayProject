...
if __name__ == '__main__':
    process("/data/yolo_dataset/train", "/data/single_dataset/train.json", "/data/single_dataset", is_multiple=False)
    process("/data/yolo_dataset/val", "/data/single_dataset/test.json", "/data/single_dataset", is_multiple=False)
